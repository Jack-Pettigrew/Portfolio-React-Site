...
export default function index() {
  return (
    <div className="flex flex-col w-full h-full p-10 text-white items-center justify-between">
      {/* <BackgroundImage /> */}
      ...
      <div className="flex flex-col sm:flex-row justify-center items-center w-[90vw] max-w-[1200px] sm:w-[80vw] sm:my-3 px-8 py-8 rounded-[25px] backdrop-blur-md bg-[rgba(38,38,38,0.75)] shadow-[5px_5px_20px_0px_rgba(0,0,0,0.5)]">
        ...
        <div
          id="headline-info"
          className="flex flex-col gap-5 text-start w-full text-lg"
        >
          <p className="before:content-['💻'] before:mr-2 before:text-xl">
            <a
          ...
          <p className="before:content-['🕹️'] before:mr-2 before:text-xl">
            <a
              className="font-bold duration-[200ms] hover:text-2xl underline underline-offset-4 decoration-wavy decoration-[#bc59fd]"
          ...
          <p>
            My experience as a developer has thrown many challenges,
            solidifying my technical skills and forming a healthy,
            enthusiastic mindset towards future developments.
          </p>

          <span className="self-center duration-[200ms] hover:rotate-[5deg]">
            {/* <GameCharacterIcon
                characterSrc="images/characters/lilal.webp"
                width="75px"
                height="75px"
              /> */}
          </span>
