...
export default function NavBar() {
  return (
    <div className="flex flex-row w-full justify-center sm:justify-end items-center text-center space-x-[2.5%] py-[15px] sm:pr-[20px] backdrop-blur-sm shadow-[inset_0_-10px_10px_-4px_rgba(0,0,0,0.3)]">
