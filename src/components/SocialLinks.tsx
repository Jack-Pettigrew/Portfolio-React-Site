import { FaGithub, FaItchIo, FaLinkedin, FaYoutube } from "react-icons/fa"
...
export default function SocialLinks({ linkSizes = "2rem", linksFlexDirection = "row" }) {
  ...
  return (
    <div className={`flex flex-${linksFlexDirection} ${linksFlexDirection == "col" ? "items-center" : ""} justify-center gap-5 text-2xl`}>
